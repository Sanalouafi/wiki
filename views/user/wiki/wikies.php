                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item wow fadeInUp">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="/wiki/public/images/about.jpg" class="img-fluid" alt="">
                                <a href="detailWiki" class="link-details" title="More Details"><i class="bx bx-link"></i></a>
                            </figure>

                            <div class="portfolio-info">
                                <h4><a href="detailWiki">App 1</a></h4>
                                <p>App</p>
                            </div>
                        </div>
                    </div>
